...
"")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("icons/people.png"))
        self.label.setObjectName("label")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(380, 450, 351, 121))
        font = QtGui.QFont()
...
"")
        ...
        self.label_2.setGeometry(QtCore.QRect(-180, 180, 501, 381))
        self.label_2.setStyleSheet("background-color: transparent;")
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("icons/ipad.png"))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(280, 90, 581, 121))
        font = QtGui.QFont()
